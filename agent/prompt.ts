...
- actualizar: cambia algo según tipo — tarea (accion: completar|reabrir|reprogramar|descripcion|mover), meta (factores o descripcion), proyecto/area (descripcion), documento (accion: editar|anexar|fijar), evento (titulo/hora/color/recurrencia), movimiento (monto/moneda/tasa/direccion/proyecto_id/categoria/descripcion/desde).
- archivar: elimina o archiva según tipo — tarea/evento/documento/recurrente/movimiento se borran; area se archiva.
